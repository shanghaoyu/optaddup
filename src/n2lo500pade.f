...
c
     ...
     1    6.000000000d0,   0.0d0,    4.0000d0,  700.0d0,   0.0d0,
     ...
     *    6.000000000d0,   0.0d0,    2.0000d0,  700.0d0,   0.0d0,
     ...
     *    1.000000000d0,   0.0d0,  138.0390d0,    1.0d0,  -1.0d0,
     ...
     6   -0.151281130d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     7    2.336086454d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     *    1.054330257d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     1    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     2    0.199132569d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     4   -0.837012181d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     6   -0.15056056543d0, 2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     7    0.443891690d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     8    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     9    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     *    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     1    0.351151131d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     2    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     3    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     4    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     5    0.000000000d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
     6   -0.636546259d0,   2.0d0,  700.0000d0,    0.0d0,   0.0d0,
...
c
      data t1s0pp/
     7   -0.15050203d0,  3.0d0,  700.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0np/
     7   -0.15128113d0,  2.0d0,  700.0000d0,    0.0d0,   0.0d0/
c
c
      data t1s0nn/
     7   -0.1509590d0,  3.0d0,  700.0000d0,    0.0d0,   0.0d0/
c
c
...
c
c
      t1s0np(1)=-12.0d0*pi*conta(4)
      tab(1,26)=-12.0d0*pi*conta(4)
      tab(1,27)=4.0d0*pi*(-3.0d0*conta(5)-0.75d0*conta(6)-conta(8)
     1          -0.25d0*conta(9))
      tab(1,30)=4.0d0*pi*(-2.0d0/3.0d0*conta(5)+1.0d0/6.0d0*conta(6)
     1          -2.0d0/3.0d0*conta(7)+2.0d0*conta(8)-0.5d0*conta(9))
      tab(1,32)=4.0d0*pi*(2.0d0*conta(5)-0.5d0*conta(6)
     1           +2.0d0/3.0d0*conta(8)-1.0d0/6.0d0*conta(9))
      tab(1,34)=4.0d0*pi*(-2.0d0/3.0d0*conta(5)+1.0d0/6.0d0*conta(6)
     1          -1.0d0/3.0d0*conta(7)-4.0d0/3.0d0*conta(8)+1.0d0/3.0d0
     2           *conta(9))
      tab(1,36)=4.0d0*pi*conta(4)
      tab(1,37)=4.0d0*pi*(conta(5)+0.25d0*conta(6)
     1           +1.0d0/3.0d0*conta(8)+1.0d0/12.0d0*conta(9))
      tab(1,41)=4.0d0*pi*(-2.0d0*dsqrt(2.0d0)/3.0d0*conta(8)
     1           -dsqrt(2.0d0)/6.0d0*conta(9) )
      tab(1,46)=4.0d0*pi*(-2.0d0/3.0d0*conta(5)+1.0d0/6.0d0*conta(6)
     1           +1.0d0/3.0d0*conta(7))
...
c
 5700 if (.not.indla.or.cc4.ne.c4) go to 20
     ...
     1     *cpaa(i)
 5705 aa(i)=aa(i)*(c5*term2+(0.01d0*wnq*conta(1)
     1     +conta(2)*wnq*wnq*1.0d-8*akk
     2     +conta(3)*wnq*wnq*1.0d-8*deltaq(i,3))/(1.0d0+conta(10)*akk))
      mi=mi+1
      mm=mm+1
      go to 5999
c
